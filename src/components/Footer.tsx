          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-primary-foreground/80 mt-4">
                After purchase, you'll receive the PDF guide directly in your email instantly.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-primary-foreground/80">
                ...
                <li><Link to="/refunds" className="hover:text-primary-foreground transition-colors">Refunds Policy</Link></li>
              </ul>
            </div>
